...
class PointCloudHeatSolverExt; // forward declare to friend below
}
...
class HeatMethodDistanceSolverExt{
    
public:
    HeatMethodDistanceSolverExt(IntrinsicGeometryInterface& geom, const SparseMatrix<double>& L, const SparseMatrix<double>& M, double tCoef = 1.0, bool useRobustLaplacian = false);
...
private:
  ...
  friend class pointcloud::PointCloudHeatSolverExt;
};
